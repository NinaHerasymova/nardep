...
//   `<svg class="icon icon-${name}"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="http://localhost/TS/wp-content/themes/TS/img/sprite.svg#icon-${name}"></use></svg>`;

export const buildIcon = (name) =>
  `<svg class="icon icon-${name}"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="./wp-content/themes/TS/img/sprite.svg#icon-${name}"></use></svg>`;
